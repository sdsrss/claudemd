...
| `session-start` | `bootstrap` / `bootstrap-sync` / `upstream-banner` / `stale-root` / `bootstrap-fail-banner` / `user-content-banner` / `user-content-banner-interrupted` / `spec-drift` | `null` |
