...
| `scripts/clean-residue.js` | Reap sentinels / stale tmp / orphan state past retention | `node scripts/clean-residue.js [--apply] [--include-unowned] [--age-days=N] [--retention-days=N]` |
