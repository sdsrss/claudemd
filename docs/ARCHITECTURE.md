...
| PostToolUse:Bash | `branch-prune.sh` | after git merge/pull/fetch/push or gh pr merge, deletes local branches whose content is already on the default branch | n/a |
