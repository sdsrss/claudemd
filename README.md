...
> A **personal AI-coding discipline harness**: one developer's opinionated **AI-CODING-SPEC v6.33**, encoded as Claude Code shell hooks and shipped with the plugin. Built and dogfooded on my own repos — fork and adapt, don't adopt wholesale.
...
| Spec v6.33 | `~/.claude/CLAUDE.md` · `CLAUDE-extended.md` · `CLAUDE-changelog.md` · `OPERATOR.md` (backup-before-overwrite) |
...
├── spec/                     # shipped v6.33 CLAUDE*.md trio + OPERATOR.md + hard-rules.json manifest
