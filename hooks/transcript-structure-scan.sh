...
hook_require_jq || { hook_record_failopen transcript-structure-scan jq-missing; exit 0; }

EVENT=$(hook_read_event) || exit 0
TRANSCRIPT_PATH=$(hook_jq_field transcript-structure-scan "$EVENT" '.transcript_path // ""') || exit 0
