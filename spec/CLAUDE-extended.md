...
**Sizing** (v6.28.0, 2026-09-07, single post-edit `wc -c`; ±20B self-rewrite envelope): core 23478 → 24468 bytes (Δ +990: §5 Hard tagged self-enforced; §8 Escape tokens and §3 User relaxation added); extended 44596 → 44431 bytes (Δ -165: the §13 partition counts and this entry); OPERATOR.md 15996 → 15996 bytes (Δ +0). Size budget: core 24468/25000 (**532 bytes headroom**); extended 44431/50000 (**5569 bytes headroom**). Drift envelope: ±20B for this line's own rewrite.
