...
**Sizing** (v6.28.0, 2026-09-07, single post-edit `wc -c`; ±20B self-rewrite envelope): core 23478 → 24593 bytes (Δ +1115: §5 Hard tagged self-enforced; §8 Escape tokens and §3 User relaxation added, both narrowed by the pre-tag review); extended 44596 → 44469 bytes (Δ -127: the §13 partition counts and this entry); OPERATOR.md 15996 → 15996 bytes (Δ +0). Size budget: core 24593/25000 (**407 bytes headroom**); extended 44469/50000 (**5531 bytes headroom**). Drift envelope: ±20B for this line's own rewrite.
