...
**Sizing** (v6.28.0, 2026-09-07, single post-edit `wc -c`; ±20B self-rewrite envelope): core 23478 → 24046 bytes (Δ +568: §5 Hard tagged self-enforced, §8 Escape tokens added); extended 44596 → 44407 bytes (Δ -189: the §13 partition counts and this entry); OPERATOR.md 15996 → 15996 bytes (Δ +0). Size budget: core 24046/25000 (**954 bytes headroom**); extended 44407/50000 (**5593 bytes headroom**). Drift envelope: ±20B for this line's own rewrite.
