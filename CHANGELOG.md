...
Verified: `npm run check` exit 0, node 1061 to 1068 pass / 0 fail, bash hook suites 1283 to 1298 pass / 0 fail plus 14 rule-hits cases, the §8 corpus 707 to 713, shellcheck clean at warning+, and the version cascade reporting 0.77.0 across 6 sites. Every defect in this release carries a test confirmed to fail against the code before it.
