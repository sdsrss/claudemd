...
One spec change: **AI-CODING-SPEC v6.27.0 → v6.28.0**, closing the three findings the 2026-09-06 audit left open in its §8 after v0.79.0 shipped the rest. Core 23478 → 24593 bytes, extended 44596 → 44469, no new HARD rule; the enforcement partition moves 6 hook / 16 self / 2 both / 1 external → 6 / 17 / 2 / 1 because a layer that was always self-enforced is now counted. The clause list is the v6.28.0 entry in `spec/CLAUDE-changelog.md`; the round's execution record is §11 of `docs/audit/20260906-231957.md`.
