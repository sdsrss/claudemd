...
Valid hook names: `session-start-check`, `version-sync`, `pre-bash-safety`, `banned-vocab`, `ship-baseline`, `memory-read-check`, `residue-audit`, `sandbox-disposal-check`, `mem-audit`, `session-summary`, `transcript-vocab-scan`, `transcript-structure-scan`, `session-end-check`.
